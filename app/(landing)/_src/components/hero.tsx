...
export function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[90vh] flex items-center justify-center sm:px-4 sm:pt-32 pt-12 md:pt-24 pb-20 overflow-hidden cursor-default">
