        ...
        <div className="max-w-5xl mx-auto">
          <div className="space-y-16">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl font-bold text-center">We're transforming how <span className="text-primary">creative professionals</span> manage their business, one workflow at a time.</h1>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Solira was born from a simple truth: Creative professionals need a different kind of tool to manage their business. We're here to transform how creatives manage their entire business,
                from client relationships to project management and much more. Our mission is to empower our users with tools that understand their workflow, speak their language, and give them more time to do
