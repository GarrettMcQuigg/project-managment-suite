            ...
            <div className="col-span-12 lg:col-span-6 space-y-16">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <p className="ml-8">• Communications between you and your clients</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p className="ml-8">• Provide and maintain our CRM services</p>
              ...
              <div className="space-y-3">
                ...
                <p className="text-md text-muted-foreground leading-relaxed">
                  We implement appropriate technical and organizational security measures to protect your personal information. These measures include encryption, secure servers,
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p className="ml-8">• Access your personal information</p>
                  <p className="ml-8">• Correct inaccurate information</p>
                  <p className="ml-8">• Request deletion of your information</p>
                  <p className="ml-8">• Object to processing of your information</p>
                </div>
              </div>
