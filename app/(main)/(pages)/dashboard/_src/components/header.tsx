...
export function Header({ currentUser }: { currentUser: User }) {
  return (
    <header className="flex h-header lg:ml-64 items-center justify-between border-b border-foreground/20 bg-gradient-to-br from-foreground/10 via-background to-background bg-background/95 px-8 backdrop-blur supports-[backdrop-filter]:bg-background/60">
