...
import { Calendar, Clock, Users, Eye, EyeOff, KeyRound, Copy, ExternalLink, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative group">
        <div className="relative bg-gradient-to-br from-primary/5 via-card to-secondary/10 dark:from-primary/10 dark:via-card/80 dark:to-secondary/20 rounded-xl shadow-lg shadow-primary/10 group-hover:shadow-primary/20 transition-all duration-500 overflow-hidden border border-border">
          ...
          <div className="absolute z-20">
            <div className="px-3 py-2 rounded-br-lg shadow-xl text-sm font-semibold bg-gradient-to-r from-primary to-primary/80 text-primary-foreground backdrop-blur-sm transform transition-transform duration-300">
              {project.status}
            </div>
          </div>
      ...
      <div className="grid gap-6 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
        ...
        {/* Timeline Card */}
        <div className="relative group">
          <div className="bg-gradient-to-br from-card to-secondary/5 dark:from-card/80 dark:to-secondary/10 rounded-xl px-6 pt-6 pb-8 shadow-lg hover:shadow-xl transition-all duration-300 transform border border-border">
      ...
      {project.invoices && project.invoices.length > 0 && (
        <div className="relative group">
          <div className="bg-gradient-to-br from-card to-secondary/5 dark:from-card/80 dark:to-secondary/20 rounded-xl shadow-lg shadow-primary/5 hover:shadow-primary/10 transition-all duration-500 border border-border overflow-hidden">
            <div className="p-6">
