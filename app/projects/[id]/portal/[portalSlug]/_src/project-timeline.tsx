                            ...
                            <div className="flex items-center justify-between mb-2">
                              ...
                              {isOwner && (
                                <button
                                  ...
                                  disabled={isUpdating}
                                  className={`ml-4 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-300 transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none ${
                                    checkpoint.status === 'COMPLETED'
                                      ...
                                      : 'bg-gradient-to-r from-gray-100 to-gray-200 hover:from-blue-50 hover:to-blue-100 text-gray-700 hover:text-blue-700 border border-gray-300 hover:border-blue-300'
                                  }`}
                                >
                                  {isUpdating ? (
                                    <div className="flex items-center gap-2">
